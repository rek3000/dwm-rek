...
// 0xF0}; static const unsigned char utfmask[UTF_SIZ + 1] = {0xC0, 0x80, 0xE0,
// 0xF0, 0xF8}; static const long utfmin[UTF_SIZ + 1] = {       0,    0,  0x80,
// 0x800,  0x10000}; static const long utfmax[UTF_SIZ + 1] = {0x10FFFF, 0x7F,
...
xfont_create(Drw *drw, const char *fontname) {
  ...
  // 		fprintf(stderr, "error, cannot parse font name to pattern:
  // '%s'\n", fontname); 		XftFontClose(drw->dpy, xfont);
  // return NULL;
  // 	}
  // } else if (fontpattern) {
